...
export type { P2Input, P2Result, AgentVerdict, CredibilityTier, SourceCredibility, ScanHistoryEntry } from './types.js';

import type { P2Input, P2Result } from './types.js';
 ...
 */
export async function scanP2(input: P2Input, apiKey: string): Promise<P2Result> {
  ...
  return mergeVerdicts(input.scan_id, [provenance, crossRef, temporal, credibility]);
}
